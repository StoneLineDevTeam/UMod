...
public:
	...
	static void PushEntity(Entity *Base, LuaInterface* Lua); //TODO : implement that method it should basicaly push an entity on the stack
	static Entity *CheckEntity(int id, LuaInterface* Lua); //TODO : implement that method it should return a valid EntityBase or Throw a lua error saying that lua gave a NULL entity !
...
private:
	static void NewEntity(Entity *Base, LuaInterface* Lua);
